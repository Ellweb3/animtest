(function (_, L) {
  ...
  var ns = (_, L, g) =>
    L in _
      ? as(_, L, { enumerable: !0, configurable: !0, writable: !0, value: g })
      : (_[L] = g);
  var D = (_, L, g) => (ns(_, typeof L != "symbol" ? L + "" : L, g), g);
  let L = 0;
  function g() {
    if (!(L > 100)) {
      if (L === 100)
  ...
  class nt {
    constructor({
      ...
      if (
        ((this.gl = this.canvas.getContext("webgl2", T)),
  ...
  class We {
    constructor(e, { parent: t, vertexShader: s, fragmentShader: i } = {}) {
      ...
      (this.renderer = e),
        (this.gl = this.renderer.gl),
        (this.parent = t),
        (this.defaultVsCode = this.parent.type === "Plane" ? dt : ut),
        (this.defaultFsCode = this.parent.type === "Plane" ? ct : ft),
        s
          ? (this.vsCode = s)
          : (!this.renderer.production &&
...
`,
    ...
    createUniforms(e) {
      (this.uniformsManager = new lt(this.renderer, this.program, e)),
        this.setUniforms();
    }
    setUniforms() {
  ...
  class Q {
    ...
    composeFromOrigin(e, t, s, i) {
      ...
      return (
        ...
        (r[10] = W),
        (r[11] = 0),
        (r[12] = e.x + X - ($ * X + v * V + Y * B)),
        (r[13] = e.y + V - (P * X + x * V + ie * B)),
        (r[14] = e.z + B - (w * X + z * V + W * B)),
        (r[15] = 1),
        this
      );
    }
...
gl.LINEAR filtering will be used instead`,
    ...
    _updateTextureMatrix(e) {
      ...
      (t.x /= this.scale.x),
        (t.y /= this.scale.y),
        (this._textureMatrix.matrix = mt.setFromArray([
          t.x,
          0,
          0,
          0,
  ...
  class xt {
    constructor(
      ...
      (this._canDraw = !1),
        ...
        (o = parseInt(o)),
        (l = parseInt(l)),
        (this._geometry = new pt(this.renderer, { width: o, height: l })),
        (this._program = new We(this.renderer, {
          parent: this,
          vertexShader: r,
          fragmentShader: a,
        })),
    ...
    _initMesh() {
      (this.uuid = Ee()),
        (this.loader = new _t(this.renderer, this, {
          sourcesLoaded: 0,
          initSourcesToLoad: 0,
          complete: !1,
          onComplete: () => {
...
`,
  ...
  class bt extends xt {
    ...
    mouseToPlaneCoords(e) {
      const t = this.scale ? this.scale : yt.set(1, 1),
        s = He.set(
  ...
  class je extends bt {
    constructor(
      ...
      t,
      {
        ...
        visible: R = !0,
        transparent: S = !1,
        drawCheckMargins: T = { top: 0, right: 0, bottom: 0, left: 0 },
        autoloadSources: E = !0,
        watchScroll: C = !0,
        fov: k = 50,
        customScale: A = 1,
    ...
    setScale(e) {
      ...
      e.sanitizeNaNValuesWith(this.scale).max(wt.set(0.001, 0.001)),
      ...
      if (s.length === 1)
        s[0] === 0
          ? ((t[0] = this._getIntersection(
            ...
            t.push(
              this._getIntersection(t[3], G.set(-1, -0.95, 0).applyMat4(i)),
            ))
          : s[0] === 1
            ? ((t[1] = this._getIntersection(
              ...
              t.push(
                this._getIntersection(t[2], G.set(1, -0.95, 0).applyMat4(i)),
              ))
            : s[0] === 2
              ? ((t[2] = this._getIntersection(
                ...
                t.push(
                  this._getIntersection(t[1], G.set(1, 0.95, 0).applyMat4(i)),
                ))
              : s[0] === 3 &&
                ...
                t.push(
                  this._getIntersection(t[0], G.set(-1, 0.95, 0).applyMat4(i)),
                ));
      else if (s.length === 2)
        s[0] === 0 && s[1] === 1
          ? ((t[0] = this._getIntersection(
        ...
        (t = [t[r]]),
          r === 0
            ? (t.push(
                this._getIntersection(t[0], H.set(-0.95, 1, 0).applyMat4(i)),
              ),
              t.push(
                this._getIntersection(t[0], G.set(-1, 0.95, 0).applyMat4(i)),
              ))
    ...
    mouseToPlaneCoords(e) {
      if (
        (Ge.setAxisOrder(this.quaternion.axisOrder),
        Ge.equals(this.quaternion) && Ct.equals(this.transformOrigin))
      )
        return super.mouseToPlaneCoords(e);
      {
        ...
        const r = kt.set(0, 0, -1);
        r.applyQuat(this.quaternion).normalize();
        const a = zt.set(0, 0, 0),
          h = r.dot(i);
        if (Math.abs(h) >= 1e-4) {
  ...
  let xe,
    ...
    Z = window.innerWidth || document.documentElement.clientWidth,
  ...
  typeof document.hidden < "u"
    ? ((xe = "hidden"), (le = "visibilitychange"))
    : typeof document.msHidden < "u"
      ? ((xe = "msHidden"), (le = "msvisibilitychange"))
      : typeof document.webkitHidden < "u" &&
        ((xe = "webkitHidden"), (le = "webkitvisibilitychange"));
  function Dt(n, e) {
    let t;
    return function (...s) {
      clearTimeout(t),
  ...
  function ze(n, e, t, s, i) {
    if (t.length > 1) {
      ...
      if (
        (i === "linear" &&
          (d = n.createLinearGradient(a - u, h - c, a + u, h + c)),
        i === "conic")
      ) {
  ...
  function we(n) {
    if (n.local.hasPingPongCache !== void 0) return n.local.hasPingPongCache;
    const e = n.usesPingPong || ["mouse", "waterRipple"].includes(n.type);
    return (n.local.hasPingPongCache = e), e;
  }
  function J(n, e) {
  ...
  function he(n) {
    ...
    const e =
      ...
      s = n.layerType === "effect" && (n.animating || we(n)),
      i = n.type === "video",
      r = e || t || s || i;
  ...
  function Ut(n, e) {
    ...
    (t.href = "https://unicorn.studio?utm_source=public-url"),
      (t.style =
        "position: absolute; display: none; bottom: 30px; left: 0; width: 190px; margin: 0; right: 0; padding: 10px; border-radius: 6px; background-color: rgba(255, 255, 255, 1); box-shadow: 0 3px 9px 0 rgba(0, 0, 0, .2); z-index: 0; box-sizing: border-box;"),
      (t.target = "_blank");
        ...
        i.isInView && i.initialized
          ? ((i.rendering = !0),
            t - (i.lastTime || 0) >= i.frameDuration &&
              !i.paused &&
              (i.updateMouseTrail(), i.renderFrame(), (i.lastTime = t)),
            (s =
              _.scenes.filter((r) => r.getDynamicLayers().length > 0).length >
              0))
          : (i.rendering = !1);
      }),
        (!ce || t - ce > 64) &&
  ...
  function ve(n, e, t) {
    return (n == null ? void 0 : n.type) === "Vec3" &&
      ...
      : (n == null ? void 0 : n.type) === "Vec2" &&
        ...
        ? new M(n._x + (e._x - n._x) * t, n._y + (e._y - n._y) * t)
        : n + (e - n) * t;
  }
  function Te(n, e) {
    return (
      n.type === "Vec2"
        ? (n = new M(n._x, e ? 1 - n._y : n._y))
        : n.type === "Vec3" && (n = new b(n._x, n._y, n._z)),
      n
    );
  }
  function Re(n, e, t) {
      ...
      return (
        ...
        this.progress === 0
          ...
          : (a >= 1 && ((this.complete = !0), (this.progress = 0)),
            (this.lastTick = s),
            this.complete ? !1 : ve(this.value, e, this.progress))
      );
    }
    resetState() {
      (this.progress = 0),
  ...
  class Wt {
    ...
    updateEffect(e, { top: t, height: s, isFixed: i }) {
      ...
      if ((i && (t -= j), this.mode === "scrollIntoView")) {
        const r = t + j - re * this.offset,
          a = r + (re + s) * this.range;
        let h = (j - r) / (a - r),
          o = Math.max(0, Math.min(1, h));
        return (
          this.lastTick !== void 0 &&
            (o = be(o, this.lastTick, this.momentum * 2)),
          this.lastTick !== void 0 && Math.abs(this.lastTick - o) < 1e-4
            ? !1
            : ((this.lastTick = o), ve(e, this.value, o))
        );
        ...
        return (
          ...
          this.lastTick !== void 0 &&
          ((r = be(r, this.lastTick, this.momentum * 2)), Math.abs(r) < 0.001)
            ? !1
  ...
  class Nt {
    ...
    updateEffect(e, t, s) {
      ...
      if (e === void 0) return !1;
      const i =
          (c = s == null ? void 0 : s.getParent) == null ? void 0 : c.call(s),
        r = performance.now();
      ...
      const d = Xe(this.transition.ease)(this.rawProgress),
      ...
      return (
        ...
        !t && !u
          ...
          : (!t &&
            ...
            (this.lastTick = r),
            (this.lastEnterTime = t),
            u ? ve(e, this.value, this.progress) : !1)
      );
    }
    resetState() {
      this.progress = 0;
      ...
      n.forEach((e) => {
        ...
        for (let i in e.props)
          ((t = e.props[i]) == null ? void 0 : t.type) === "Vec2"
            ? (e.props[i] = new M(e.props[i]._x, e.props[i]._y))
  ...
  class Qe {
    ...
    updateStateEffects() {
      ...
      (!this.local.cachedBreakpoint ||
        this.local.cachedBreakpoint !==
          ((r = e.currentBreakpoint) == null ? void 0 : r.name)) &&
        (this.local.cachedBreakpoint =
          (a = e.currentBreakpoint) == null ? void 0 : a.name);
      const t = (h) =>
        !h.breakpoints || h.breakpoints.length === 0
          ? !0
          : h.breakpoints.find((o) => o === this.local.cachedBreakpoint);
      e.isInView &&
        (this.local.createdAt === null &&
          (this.local.createdAt = performance.now()),
        this.states.appear.forEach((h) => {
          if (!t(h)) return;
          let o = h.startTime || this.local.createdAt;
          if (!h.initialized) {
            const d = [
              ...this.states.appear.filter((u) => u.prop === h.prop),
            ].sort(
          ...
          e != null &&
            e.pauseTime &&
            (o += Math.abs(e == null ? void 0 : e.pauseTime));
          ...
          l !== !1 &&
            ...
            this.isElement &&
              h.complete &&
              this.removeStateEffectProperty(h.prop);
        })),
          ...
          (this.getPlanes().forEach((h) => {
            ...
            for (let l of this.local.updatedProps) {
              ...
              d !== void 0 &&
                ...
                (h.uniforms[l] && Re(d, h.uniforms[l], l),
                this.updateStateEffectProperty(l, d));
            }
          }),
          this.isElement &&
    ...
    invalidatePerformanceCaches() {
      (this.local.isDynamicCache = void 0),
        (this.local.hasPingPongCache = void 0),
  ...
  let De = class extends Qe {
    ...
    resize() {
      ...
      this.render(),
        this.layerType === "text" && Ye(this, this.state().element);
    }
    dispose() {
      this.local.canvas &&
    ...
    getAbsolutePosition() {
      ...
      let r =
          ((d = (l = this.local) == null ? void 0 : l.stateEffectProps) == null
            ...
            : d.left) ?? this.left,
        a =
          ((c = (u = this.local) == null ? void 0 : u.stateEffectProps) == null
            ? void 0
            : c.top) ?? this.top;
  ...
  class Gt extends De {
    ...
    render() {
      ...
      const o = oe(this.anchorPoint);
      let l =
          ((f = this.local.stateEffectProps) == null
            ? void 0
            : f.borderRadius) ?? this.borderRadius,
        d =
          ((p = this.local.stateEffectProps) == null
            ? void 0
    ...
    unpackage() {
      for (let t in this)
        this[t] &&
          this[t].type &&
          (this[t].type === "Vec2"
            ? (this[t] = new M(this[t]._x, this[t]._y))
            : this[t].type === "Vec3" &&
              (this[t] = new b(this[t]._x, this[t]._y, this[t]._z)));
      return this;
    }
    getParent() {
      return this.state()
  ...
  class Xt extends De {
    ...
    renderImage() {
      ...
      if (this.fitToCanvas) {
        ...
        const c = oe(this.anchorPoint),
          f =
            (((u = this.local.stateEffectProps) == null
              ? void 0
        ...
        t.translate(T, E),
          t.rotate(f),
          t.drawImage(this.local.img, -R, -S, a, h),
          t.restore();
      }
    }
    render() {}
  ...
  class Yt extends De {
    ...
    loadFont() {
      ...
      document.fonts.add(h),
        h
          ...
          .catch((o) => {
            console.error("Font loading error:", o), this.handleFontLoaded();
          });
    }
    handleFontLoaded() {
      (this.local.loaded = !0), this.render(), this.render();
      const t = this.state();
      t.renderFrame && t.renderFrame(), Ye(this, this.state().element);
    }
    ...
    render() {
      ...
      const a = oe(this.anchorPoint),
        h =
          (($ = (B = this.local) == null ? void 0 : B.stateEffectProps) == null
            ? void 0
      ...
      let o = this.state(),
        ...
        R = this.fontStyle.includes("italic") ? "italic" : "normal",
        S = /^\d+$/.test(this.fontStyle) ? this.fontStyle : "400";
      t.clearRect(0, 0, o.canvasWidth, o.canvasHeight),
        (t.font = `${R} ${S} ${f}px/${p}px ${this.fontFamily}, -apple-system, BlinkMacSystemFont, Helvetica, Arial`),
        this.isSafari ||
          ((t.textAlign = this.textAlign), (t.letterSpacing = m + "px"));
      const T = t.measureText("m").width;
      (r = Math.max(r, T)), t.save();
      let E = d + r / 2,
        C = u + l / 2;
      t.translate(E, C),
      ...
      const k = (P, w, v, x, z, Y, ie) => {
          let W = w
              ...
              .reduce(
                (I, K, rs) =>
                  I + P.measureText(K).width + (rs < w.length - 1 ? z : 0),
                0,
              ),
            N;
          if (
            (Y === "center" ? (N = v + (ie - W) / 2 - ie / 2) : (N = v),
            Y === "right")
          )
            for (let I = w.length - 1; I >= 0; I--) {
              const K = w[I];
              (N -= P.measureText(K).width),
                P.fillText(K, N, x),
                I > 0 && (N -= z);
            }
          else
            for (let I = 0; I < w.length; I++)
              P.fillText(w[I], N, x), (N += P.measureText(w[I]).width + z);
        },
        A = (P, w) => {
          let v = u + p * w + p / 2 + f / 3;
          this.isSafari
            ? k(t, P, d, v, m, this.textAlign, r)
            : t.fillText(P, d, v);
        },
        y = this.textContent
...
`)
      ...
      const X = (P, w, v) =>
        w
          ...
          .reduce(
            (z, Y, ie) => (
              (z += P.measureText(Y).width), ie < w.length - 1 && (z += v), z
            ),
            0,
          );
      for (let P = 0; P < U; P++) {
...
`
            ...
            if (w !== "")
              (y[P] = w.trim()),
                x !== v.length - 1
                  ? (y.splice(P + 1, 0, v.slice(x).join("")), U++)
                  : z !==
                      `
` && y.push(z);
            else {
              ...
              for (; W.length > 0; ) {
                ...
                for (
                  let K = 0;
                  K < W.length &&
                  (t.measureText(I + W[K]).width <= r || K == 0);
                  K++
                )
                  I += W[K];
                (W = W.slice(I.length)),
                  (y[N] = I.trim()),
                  W.length > 0 && (y.splice(N + 1, 0, W), N++, U++);
              }
              v.slice(x + 1).length > 0 && (y[N] += v.slice(x + 1).join(""));
            }
            break;
          } else w = Y;
  ...
  function Oe() {
    _.scenes
      ...
      .forEach((n) => {
        ...
        (n.scrollY = j),
          n.lastBbox &&
            (Math.abs(e.top - n.lastBbox.top) === 0 && de > 0
        ...
        Je(i.element, i.bbox, 100)
          ? i.isInView ||
            ...
            i.lazyLoad &&
              ...
              i.initializePlanes())
          : i.isInView &&
            ((i.isInView = !1), (i.pauseTime = performance.now()));
      });
  }
  function qt() {
    _.scenes.forEach((n) => {
      ...
      if (
        ...
        !(
          Pe() &&
          (i = (s = n.interactivity) == null ? void 0 : s.mouse) != null &&
          i.disableMobile
        )
      ) {
        ...
        (e.mouse.movedInView = !0),
          ...
          e.isFixed &&
            ...
            n.targetTouches
              ...
              : (i = n.clientY));
        const r = s - t.left,
          a = i - (t.top + (e.isFixed ? 0 : j));
        (e.mouse.page.x = s),
          (e.mouse.page.y = i),
          (e.mouse.movePos.x = r * 0.5),
          (e.mouse.movePos.y = a * 0.5);
      }),
      Ae || (Ae = !0);
  }
  _.scenes = [];
  class Qt {
    constructor(e) {
      ...
      (this.id = e.id),
        ...
        (this.canvasWidth = e.width || e.element.offsetWidth || Z),
        ...
        this.createCurtains(),
        this.setCanvasScale(),
        this.curtain && (this.textureLoader = new Ne(this.curtain));
    }
    preloadTextures() {
            ...
            const u =
              ...
              c =
                ...
                ((d =
                  ...
                  : d.sampler) ||
                "uTexture";
            (this.local.preloadedTextures[u] = null),
              this.local.preloadedTextures[u] ||
                this.textureLoader.loadImage(
                  u,
                  { sampler: c, premultipliedAlpha: !1 },
                  (f) => {
                    this.local.preloadedTextures[u] = f;
                  },
                );
          }
          if (e.type === "video" && e.src) {
            const u = e.src.includes(", ") ? $e(e.src) : e.src,
              c = u;
            this.local.preloadedTextures[c] ||
              this.textureLoader.loadVideo(
                u,
                { sampler: "uVideoTexture", premultipliedAlpha: !0 },
                (f) => {
                  this.local.preloadedTextures[c] = f;
                  const p = f.source && f.source.element;
                  p && typeof p.play == "function" && p.play().catch(() => {});
                },
              );
          }
        }
    ...
    getDynamicLayers() {
      return this.layers.filter((e) => he(e));
    }
    createCurtains() {
      (this.curtain = new ot({
      ...
      if (s) {
        let i = s.parentLayer ? s.getParent() : null,
          ...
          a =
            ...
            i.effects &&
            i.effects.length &&
            i.getChildEffectItems().filter((h) => he(h)).length;
        for (; s && !he(s) && !r && !a; )
          t++,
            (s = e[t]),
            s &&
    ...
    getPlaneParams(e, t) {
      ...
      const i = {
        resolution: {
          name: "uResolution",
          type: "2f",
          value: new M(this.canvasWidth, this.canvasHeight),
        },
        mousePos: { name: "uMousePos", type: "2f", value: new M(0.5) },
        ...
        (e.states &&
          [...e.states.appear, ...e.states.scroll, ...e.states.hover].forEach(
            (c) => {
              i[c.prop] ||
                (c.uniformData &&
                  ((i[c.prop] = c.uniformData), (i[c.prop].value = e[c.prop])));
            },
          ),
          ...
          (i[c] = e.data.uniforms[c]),
            ((d = f.value) == null ? void 0 : d.type) === "Vec3"
              ...
              : ((u = f.value) == null ? void 0 : u.type) === "Vec2"
                ? (i[c].value = new M(f.value._x, f.value._y))
      ...
      try {
        ...
        if (
          ...
          e.userDownsample &&
            ...
            (o *= e.userDownsample),
          (r = new je(this.curtain, this.curtain.container, i)),
    ...
    createPingPongPlane(e, t, s) {
      ...
      if (r) r.setRenderOrder(t);
        ...
        if (((r = new Lt(this.curtain, this.curtain.container, i)), !r)) return;
        (r.userData.id = e.local.id),
    ...
    handleMediaTextures(e, t, s) {
      ...
      if (
            ...
            if (
              ...
              o
                ...
                : this.textureLoader.loadImage(
                    ...
                    (l) => {
                      O(e, r.sampler, l), (e.userData.textureLoaded = !0);
                    },
                  );
            }
          }),
        ...
        const r = t.src.includes(", ") ? $e(t.src) : t.src,
          a = this.local.preloadedTextures[r];
        a
          ? e.addTexture(a)
          : e.loadVideo(
              r,
    ...
    handleEffectPlane(e, t, s) {
      ...
      if (
        (a &&
          ...
          O(i, "uPingPongTexture", a.getTexture()),
        r
          ? O(i, "uTexture", r.getTexture())
          : Le(i, this.canvasWidth, this.canvasHeight),
        h != null && h.includes("uBgTexture"))
      ) {
        let l = this.getRenderTargets()[t - (1 + s.passIndex)];
        l && O(i, "uBgTexture", l.getTexture());
      }
    ...
    handleElementPlane(e, t) {
      ...
      if (
        ...
        a || Le(s, this.canvasWidth, this.canvasHeight),
        a && i.length
          ? O(s, "uTexture", a.getTexture())
        ...
        a &&
          (O(s, "uBgTexture", a.getTexture()),
          o && e.mask && O(s, "uPreviousLayerTexture", o.getTexture()));
      }
    }
    handleChildEffectPlane(e, t, s) {
      ...
      if (
        ...
        h &&
          ...
          O(i, "uPingPongTexture", h.getTexture()),
        o != null && o.includes("uBgTexture"))
      )
        if (d && s.length > 1) {
          let p = this.getRenderTargets()[t - (1 + s.length)];
          p && O(i, "uBgTexture", p.getTexture());
        } else O(i, "uBgTexture", r.preloadedCanvasTexture);
      e.type === "custom" && O(i, "uCustomTexture", this.getRenderTargets()[t]),
        this.handleMediaTextures(i, e, s);
    }
    createPlanes() {
    ...
    createEffectPlanes(e, t) {
      ...
      s.passes && s.passes.length
        ? (this.createEffectPlane(e, t, {
          ...
          we(e) && this.createPingPongPlane(e, t, s.passes))
        : (this.createEffectPlane(e, t),
          we(e) && this.createPingPongPlane(e, t));
    }
    createTextures() {
    ...
    isNotReady(e) {
      ...
      return !!(
        ...
        (e.userData.hasOwnProperty("textureLoaded") &&
          !e.userData.textureLoaded)
      );
    }
    checkIfReady(e) {
      const t = () => {
    ...
    setElementPlaneUniforms(e, t) {
      if (e.uniforms.mousePos) {
        ...
        this.mouse.movedInView &&
          (e.uniforms.mousePos.value.x !== s.mousePos.x ||
            e.uniforms.mousePos.value.y !== s.mousePos.y) &&
          ((e.uniforms.mousePos.value.x = s.mousePos.x),
          (e.uniforms.mousePos.value.y = s.mousePos.y));
      }
    }
    calculateItemMouseValues(e) {
      ...
      const t = { x: this.mouse.pos.x, y: this.mouse.pos.y },
        s = this.bbox.width / 2,
        i = this.bbox.height / 2,
        r = e.mouseMomentum || 0;
      let a = this.mouse.pos.x,
        h = this.mouse.pos.y;
      if (r) {
        e.local.lastMousePos ||
          (e.local.lastMousePos = { x: a / s, y: 1 - h / i });
        ...
        const u = Math.abs(a - l),
          ...
          f = 0.001;
        if (u < f && c < f) {
          if (e.local.lastCalculatedMouseValues)
            return e.local.lastCalculatedMouseValues;
        } else (a = be(a, l, r * 2)), (h = be(h, d, r * 2));
        (e.local.lastMousePos.x = a / s), (e.local.lastMousePos.y = 1 - h / i);
      }
      this.local.mouseValuePool ||
        (this.local.mouseValuePool = {
          mousePos: new M(0.5, 0.5),
          previousMousePos: new M(0.5, 0.5),
          result: { mousePos: null, previousMousePos: null },
        });
      const o = this.local.mouseValuePool;
      return (
        (o.mousePos.x = a / s),
        (o.mousePos.y = 1 - h / i),
        this.mouse.trail.length > 2
          ? ((o.previousMousePos.x =
              this.mouse.trail[this.mouse.trail.length - 3][0]),
            (o.previousMousePos.y =
              this.mouse.trail[this.mouse.trail.length - 3][1]))
          : ((o.previousMousePos.x = o.mousePos.x),
            (o.previousMousePos.y = o.mousePos.y)),
        (o.result.mousePos = o.mousePos),
        (o.result.previousMousePos = o.previousMousePos),
        (e.local.lastCalculatedMousePos = t),
        (e.local.lastCalculatedMouseValues = o.result),
        o.result
      );
    }
    setEffectPlaneUniforms(e, t) {
      ...
      if (
        ...
        return !1;
      const i = this.calculateItemMouseValues(t);
      i &&
        (e.uniforms.mousePos &&
          !i.mousePos.equals(e.uniforms.mousePos.value) &&
          ((e.uniforms.mousePos.value.x = i.mousePos.x),
          (e.uniforms.mousePos.value.y = i.mousePos.y)),
        e.uniforms.previousMousePos &&
          !i.previousMousePos.equals(e.uniforms.previousMousePos.value) &&
          ((e.uniforms.previousMousePos.value.x = i.previousMousePos.x),
          (e.uniforms.previousMousePos.value.y = i.previousMousePos.y)));
    }
    getOrderedItems() {
      let e = [];
      return (
  ...
  function Jt() {
    te(window, "scroll", Ke),
      Pe() ? te(window, "touchmove", Se) : te(window, "mousemove", Se),
      te(window, "routeChange", qe),
      te(document, "mouseleave", et),
      (ne = Dt($t, 16)),
      Pe() ? te(window, "orientationchange", ne) : te(window, "resize", ne),
      te(document, le, Ze),
      (ke = !0);
  }
  function Ue() {
    se(window, "mousemove", Se),
      ...
      se(window, "scroll", Ke),
      se(window, "routeChange", qe),
      se(document, "mouseleave", et),
      ne && (se(window, "resize", ne), se(window, "orientationchange", ne)),
      se(document, le, Ze),
      (ke = !1);
  }
  function Kt(n, e, t) {
    ...
    return new Promise((s, i) => {
      ts(e, t, n.filePath, i, n.production)
        .then((r) => {
          ...
          const u = Ot(r.history, o, Kt(h, l, d)),
            c = new Qt({
              id: o,
              fps: n.fps || a.fps || 60,
              dpi: d,
          ...
          (f || a[fe("aW5jbHVkZUxvZ28=")]) && Ut(o, h),
            f && console.log(fe("SGV5")),
            _.scenes.push(c),
            (c.layers = u),
            c.preloadTextures(),
            (c.mouse.recordTrail = !!c.layers.find((p) => p.type == "mouse")),
            c.setInteractiveParams(n, a),
            (c.isInView = c.isFixed || Je(c.element, c.bbox, 50)),
  ...
  function is() {
    return ss()
      ? new Promise((n, e) => {
          ...
          t.filter((s) => !s.getAttribute("data-us-initialized")).forEach(
            (s, i) => {
